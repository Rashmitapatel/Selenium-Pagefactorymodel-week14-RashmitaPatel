...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductArrangeInAlphabeticalOrder() throws InterruptedException {
        ...
        computerPage.selectByVisibleTextFromDropDown("Name: Z to A");
        Thread.sleep(1000);
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        billingPage.enterFirstname("Rashmita");
        billingPage.enterLastname("Patel");
        billingPage.enterEmail("PatelR@gmail.com");
        billingPage.selectCountry("United Kingdom");
        billingPage.enterCity("Slough");
        billingPage.enterAddress("2,Dentonway");
        billingPage.enterPostcode("SL3 7DJ");
        billingPage.enterPhoneNumber("5678901234");
        ...
        billingPage.enterCardNumber("4105106107108100");
        billingPage.selectExpiryMonth(1);
        billingPage.selectExpiryYear(2);
        billingPage.enterCVV("567");
